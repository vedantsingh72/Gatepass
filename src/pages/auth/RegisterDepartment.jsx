...
/**
 * Department Register Page
 * Allows new departments to register
 * Uses POST /api/department/register
 */
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex items-center justify-center py-12">
        ...
        <h2 className="text-2xl font-bold text-center mb-6">Department Registration</h2>
