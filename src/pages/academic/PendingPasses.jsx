...
const PendingPasses = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Pending Academic Approvals</h1>
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Department: {pass.student?.department || 'N/A'}
                  </p>
                </div>
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-700 mb-2">
                  <strong>Reason:</strong> {pass.reason || pass.reasonForLeave}
                </p>
                <p className="text-sm text-gray-600">
